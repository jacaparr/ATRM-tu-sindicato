const CACHE_NAME = 'atrm-cache-v23';
const ASSETS_TO_CACHE = [
  ...
  './noticias.html',
  './podcasts.html',
  './verificador-nomina.html',
  './calculadora-despido.html',
  './calculadora-jubilacion.html',
  './actas-transparencia.html',
  './calendario-laboral.html',
  './css/nav.css',
...
self.addEventListener('push', function(event) {
  if (event.data) {
    ...
    const options = {
      body: data.body,
      icon: data.icon || './assets/pwa/icon-192x192.png',
...
self.addEventListener('notificationclick', function(event) {
  ...
  event.waitUntil(
    clients.openWindow('https://atrm-murcia.com')
  );
});
